...
class Ltriple extends StatelessWidget with L {
  // Split rule:
  // s > 0  -> horizontal
  // s < 0  -> vertical
  ...
  const Ltriple({
    ...
    super.key,
         ...
         first is Template,
         'Ltriple first child must be a Template variant',
       ),
       assert(
         middle is Template,
         'Ltriple middle child must be a Template variant',
       ),
       assert(
         last is Template,
         'Ltriple last child must be a Template variant',
       );
